      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            path: webHandoffPath,
            builder: (_, _) =>
                const DeviceClassScope(child: WebHandoffScreen()),
          ),
          GoRoute(
            path: blockedSurfacePath,
            builder: (_, _) =>
                const DeviceClassScope(child: BlockedSurfaceScreen()),
          ),
          GoRoute(
          ...
          GoRoute(
            ...
            routes: [
              GoRoute(
                path: 'requests',
                builder: (_, _) =>
                    const DeviceClassScope(child: IdleHomeScreen()),
              ),
            ],
          ),
          GoRoute(
            ...
            routes: [
              GoRoute(
                path: 'requests',
                builder: (_, _) =>
                    const DeviceClassScope(child: CallHomeScreen()),
              ),
            ],
          ),
          GoRoute(
